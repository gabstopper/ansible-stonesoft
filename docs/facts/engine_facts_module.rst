...
.. raw:: html
    ...
    <td align=center>[{'alias_value': [], 'allow_email_upn_lookup': False, 'auto_reboot_timeout': 10, 'antivirus': {'antivirus_update_day': 'mo', 'antivirus_http_proxy_enabled': False, 'antivirus_proxy_password': '*****', 'antivirus_proxy_port': 0, 'antivirus_enabled': False, 'virus_log_level': 'undefined', 'antivirus_update': 'never', 'antivirus_update_time': 0}, '...': None}]</td>
    </tr>
    </table>
    </br></br>
